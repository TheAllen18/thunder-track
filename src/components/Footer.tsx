...
const Footer: React.FC = () => {
  return (
    <footer className="bg-zinc-900 border-t border-green-800/20" id="contact">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/quote" className="text-zinc-300 hover:text-thunder font-montserrat transition-colors">Get a Quote</Link></li>
              <li><a href="#contact" className="text-zinc-300 hover:text-thunder font-montserrat transition-colors">Contact</a></li>
            </ul>
          </div>
