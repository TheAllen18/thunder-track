        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-8 h-8 flex items-center justify-center rounded-full bg-zinc-100 hover:bg-green-600 hover:text-white transition-colors text-zinc-800">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#calculator" className="text-zinc-700 hover:text-thunder font-montserrat transition-colors">Calculator</a></li>
              <li><a href="#about" className="text-zinc-700 hover:text-thunder font-montserrat transition-colors">About</a></li>
              <li><Link to="/quote" className="text-zinc-700 hover:text-thunder font-montserrat transition-colors">Get a Quote</Link></li>
              <li><a href="#contact" className="text-zinc-700 hover:text-thunder font-montserrat transition-colors">Contact</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-3 text-zinc-700">
                ...
                <span className="font-montserrat text-sm">+91 98765 43210</span>
              </li>
              <li className="flex items-start gap-3 text-zinc-700">
