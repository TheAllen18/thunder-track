      ...
      <main className="flex-1">
        <div className="bg-white py-8 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 text-center relative z-10 rounded-xl">
            <h1 className="text-4xl md:text-5xl font-bold mb-2 text-gray-900 font-poppins animate-fade-in">
            ...
            <a 
              href="#calculator"
              className="inline-flex items-center mt-6 text-white bg-premium-gradient hover:opacity-90 px-6 py-3 rounded-full transition-all hover:scale-105 hover:shadow-lg group border border-green-600/30 hover:border-green-600/50 font-montserrat animate-fade-in"
        ...
        <div className="container mx-auto px-4 py-6 bg-white relative z-10" id="calculator">
